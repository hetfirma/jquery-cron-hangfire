...
/// jQuery Cron Builder for Hangfire
/// Originally based on jQuery Cron Builder by https://github.com/juliacscai

;(function($) {
    "use strict";
    // Define the HTML structure and input templates for each cron period
    var cronInputs = {
        period: `
    ...
    $.cronBuilder = function(el, options) {
        ...
        base.init = function() {
            ...
            base.$el.find("select.cron-period-select")
                .append(periodOpts)
                .val('Weekly') // Set 'Weekly' as the default selected value
        ...
        base.getExpression = function() {
            ...
            var dow = "*"; // no specific day of week by default
            var month ="*", dom = "*";
            ...
            // Note: Hangfire does not support seconds, so we ignore it
